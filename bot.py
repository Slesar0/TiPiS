...
async def check_with_ai(content: str) -> str:
    ...
    prompt = f"""
Оцени лабораторную работу студента будто ты преподаватель в ВУЗе и дай развернутую оценку.

КРИТЕРИИ ОЦЕНКИ (100 баллов максимум):
1. Работоспособность и качество кода (0-40 баллов)
2. Полнота и правильность реализации (0-35 баллов)  
3. Наличие и качество комментариев (0-15 баллов)
4. Чистота и оформление кода (0-10 баллов)
...
Объективный, конструктивный, ориентированный на помощь в обучении анализ. Формулировки должны быть понятными для студентов.
"""
